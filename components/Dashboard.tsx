...
export const Dashboard: React.FC = () => {
  ...
  const NavItem: React.FC<{ view: View; label: string; icon: React.ReactElement }> = ({
    view,
    label,
    icon,
  }) => (
          ...
          <NavItem
            ...
            icon={
              <svg
                ...
                fill="currentColor"
              >
                <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L9 9.61v5.07L4.618 12.39a1 1 0 00-1.236 1.236l5 2a1 1 0 001.236 0l5-2a1 1 0 00-1.236-1.236L11 14.68V9.61l6.606-2.69a1 1 0 000-1.84l-7-3zM9 11.42l-5-2V7.17l5 2v2.25zM11 11.42V9.17l5-2V7.42l-5 2v2z" />
              </svg>
            }
          />
          <NavItem
