...
export const MealPlanner: React.FC = () => {
  ...
  const [isShoppingListLoading, setIsShoppingListLoading] =
  ...
  const handleSubmit = useCallback(
    async (event: React.FormEvent) => {
      ...
      try {
        ...
        setError(
          "An error occurred. Please review your selections and try again."
        );
        console.error(err);
      } finally {
        setIsLoading(false);
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-700 mb-2">
          Design Your Weekly Menu
        </h2>
        <p className="text-gray-500 mb-6">
          Tell us your goals, and we'll craft a personalized meal plan for you.
        </p>
